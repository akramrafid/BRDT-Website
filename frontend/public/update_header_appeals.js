...
const headerRegex = /<li class="has-dropdown">\s*<a href="#">Appeals <i class="fa-solid fa-chevron-down dropdown-icon"><\/i><\/a>\s*<ul class="dropdown-menu">([\s\S]*?)<\/ul>\s*<\/li>/;
...
files.forEach(file => {
  ...
  if (headerRegex.test(content)) {
    content = content.replace(headerRegex, `<li class="has-dropdown">\n            <a href="#">Appeals <i class="fa-solid fa-chevron-down dropdown-icon"></i></a>\n            <ul class="dropdown-menu">${newHeaderList}</ul>\n          </li>`);
    changed = true;
  }
